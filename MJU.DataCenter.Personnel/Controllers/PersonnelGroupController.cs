...
namespace MJU.DataCenter.Personnel.Controllers
{
    ...
    public class PersonnelGroupController : Controller
    {
        ...
        public PersonnelGroupController(IPersonnelService personnelService, IConfiguration configuration)
        {
        ...
        public object Get(int type, [FromQuery] AuthenticateModel auth)
        {
            ...
            if (result.Result.IsSuccess)
            {
                ...
                return _personnelService.GetAllPersonnelGroup(type, filter);
            }
            return null;
        }
        ...
        public object Get(string type, [FromQuery] AuthenticateModel auth)
        {
            ...
            if (result.Result.IsSuccess)
            {
                ...
                return _personnelService.GetAllPersonnelGroupDataSource(type, filter);
            }
            return null;
        }
