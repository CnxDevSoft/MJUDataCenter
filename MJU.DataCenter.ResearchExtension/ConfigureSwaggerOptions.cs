...
namespace MJU.DataCenter.ResearchExtension
{
    public class ConfigureSwaggerOptions : IConfigureOptions<SwaggerGenOptions>
    {
        ...
        static OpenApiInfo CreateInfoForApiVersion(ApiVersionDescription description)
        {
            ...
            {
                info.Title = "Maejo Research External API";
                info.Description = " API สำหรับการดึงข้อมูลงานวิจัยจากหน่วยงานมหาวิทยาลัยแม่โจ้";
            }
            else
            {
                info.Title = "Maejo Research Internal API";
                info.Description = " API สำหรับการจัดการข้อมูลงานวิจัยจากหน่วยงานมหาวิทยาลัยแม่โจ้";
            }
