...
{
    public class ResearchPersonnelRepository : Repository<ResearchPersonnel>, IResearchPersonnelRepository
    {
        public ResearchPersonnelRepository(ResearchExtensionContext context)
          : base(context)
        {
        }
    }
