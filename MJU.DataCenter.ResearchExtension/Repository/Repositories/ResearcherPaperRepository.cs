...
{
    public class ResearcherPaperRepository : Repository<ResearcherPaper>,IResearcherPaperRepository
    {
        public ResearcherPaperRepository(ResearchExtensionContext context)
          : base(context)
        {
        }
    }
