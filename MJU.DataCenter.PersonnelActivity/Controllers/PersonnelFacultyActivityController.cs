...
namespace MJU.DataCenter.PersonnelActivity.Controllers
{
    ...
    [ApiController]
    public class PersonnelFacultyActivityController : ControllerBase
    {

        private readonly IPersonnelActivityService _personnelActivityService;
        private readonly IConfiguration _configuration;

        public PersonnelFacultyActivityController(IPersonnelActivityService personnelActivityService, IConfiguration configuration)
        {
